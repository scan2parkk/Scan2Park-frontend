...
function CoreValuesSection() {
  return (
    <section className="relative bg-gray-900 text-white font-sans py-16 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-transparent text-white rounded-lg p-6 shadow-lg flex flex-col items-start ">
            ...
            <ul className="text-sm text-white list-disc list-inside space-y-2 text-left">
              <li>
                We challenge our assumptions by staying humble and aware that we
                don’t know it all. We keep learning.
              </li>
              <li>
                We welcome opportunities that change brings, and we dare to try
                new things. We are not afraid to fail and try again, and we
          ...
          <div className="bg-transparent text-white rounded-lg p-6 shadow-lg flex flex-col items-start ">
            ...
            <ul className="text-sm text-white list-disc list-inside space-y-2 text-left">
              ...
              <li>
                We build tomorrow, focusing on the future more than the past. We
                work on continuous improvements and innovation, taking steps
                towards our vision.
              </li>
            </ul>
          </div>
          ...
          <div className="bg-transparent text-white rounded-lg p-6 shadow-lg flex flex-col items-start ">
            ...
            <ul className="text-sm text-white list-disc list-inside space-y-2 text-left">
              <li>
                We care for and support our colleagues, customers, partners and
                communities. We act with integrity and empathy. We build an
                inclusive workplace where everyone can be their authentic self.
              </li>
              <li>
