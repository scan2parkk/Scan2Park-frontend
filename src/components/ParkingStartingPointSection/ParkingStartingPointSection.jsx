        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 max-w-7xl mx-auto">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-lg text-gray-600 mb-8">
              At the start, we just wanted to make parking easier. Today, we’re
              the leading provider of parking solutions in the U.S. and it’s our
              mission to make cities more livable.
            </p>
              ...
              >
                <span
                  className={`absolute inset-0 bg-green-700 transition-transform duration-200 ease-out ${
                    isVideoButtonHovered ? "translate-x-0" : "-translate-x-full"
                  }`}
                ></span>
